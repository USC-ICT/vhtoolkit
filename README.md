...
The [Virtual Human Toolkit](https://vhtoolkit.ict.usc.edu) (VHToolkit) is a research and development platform for the creation of virtual humans, also called embodied conversational agents or socially intelligent agents. The VHToolkit enables the creation and deployment of real-time interactive characters that perceive end-users and respond both verbally and nonverbally.
...
![VHToolkit characters](https://vhtoolkit.ict.usc.edu/images/VHToolkit-UI.jpeg)

The VHToolkit is powered by the Rapid Integration & Development Environment platform ([RIDE](https://ride.ict.usc.edu)) and targets game engine [Unity](https://unity.com). 

## Documentation
Detailed documentation can be found at this GitHub's [Wiki section](https://github.com/USC-ICT/vhtoolkit/wiki). 
